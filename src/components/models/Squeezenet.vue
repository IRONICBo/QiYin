...
import ImageModelUI from "@/components/common/ImageModelUI.vue";
import { Tensor } from "onnxruntime-web";
import { imagenetUtils } from "@/utils/imagenetHelper";

const MODEL_FILEPATH_PROD = `/onnxruntime-web-demo/squeezenet1_1.onnx`;
const MODEL_FILEPATH_DEV = "/squeezenet1_1.onnx";

export default class SqueezeNet extends ImageModelUI {
  ...
  getPredictedClass(res: Float32Array): {} {
    ...
    const output = imagenetUtils.softmax(Array.prototype.slice.call(res));
